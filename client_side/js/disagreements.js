...
window.DISAGREEMENTS = [
  {
    snippet: 2,
    text: `In previous rounds, experts disagreed on whether Snippet 2 is distinctly simpler than Snippets 4 and 7, or about the same level.
<ul>
...
<details>
  ...
  {
    snippet: 4,
    text: `Experts diverged on whether Snippet 4 should be above, below, or tied with Snippet 7, and whether it is distinct from or tied with Snippet 2. A key point is how much <code>regionMatches</code> (and similar APIs) create real barriers for typical engineers.
<ul>
...
<details>
  ...
  {
    snippet: 5,
    text: `Experts disagreed on whether Snippet 5 should be ranked above or below Snippet 7. The crux is how much specialized knowledge of the Java File API and the Visitor pattern should be assumed for typical engineers.
<ul>
...
<details>
  ...
  {
    snippet: 7,
    text: `Snippet 7 sits at the center of multiple disagreements:
<ul>
