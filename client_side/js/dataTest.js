...
`
    ...
    const general_questions = [
      ...
      const StartingQuestions = [{
        "type": "none",
        "id": "Read",
        "prompt": "<p class=\"instruction\"><strong>Please read the code snippet and form an overall impression.</strong><span class=\"emphasis\">This should take no more than 2 minutes.</span></p><p class=\"instruction\">When you're ready, click <strong>'Next'</strong> to proceed to the questions. <em>(You will still be able to see the snippet while answering.)</em></p>",
        "type2": "",
        "id2": "",
        "question2": ""
      }];
